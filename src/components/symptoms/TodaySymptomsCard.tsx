...
export function TodaySymptomsCard({ symptomLog }: Props) {
    ...
    >
      ...
      <div className="px-5 pt-4 pb-3" style={{ borderBottom: '1px solid var(--color-peat-light)' }}>
        <div className="flex items-center justify-between">
          <p className="text-sm font-semibold" style={{ color: 'var(--color-text-primary)' }}>Today's symptoms</p>
          {symptomLog?.feeling_emoji && (
